...
public class AboutView extends DialogFragment {
	...
	private LinearLayout fragLaunchButton;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		fragLaunchButton = (LinearLayout) aboutView.findViewById(R.id.launchFragButton);
		fragLaunchButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(Intent.ACTION_VIEW);
				intent.setData(Uri.parse(fragdeluxeCredit));
