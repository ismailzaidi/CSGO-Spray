...
public  class SMGFragmentTab extends Fragment {
	...
	public static SMGFragmentTab InstanceOf() {
		SMGFragmentTab fragment = new SMGFragmentTab();
		Bundle bundle = new Bundle();
		bundle.putString(KEY_WEAPON, "smgs");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		holder.view = inflater.inflate(R.layout.fragment_tab_smg, container,
				false);
