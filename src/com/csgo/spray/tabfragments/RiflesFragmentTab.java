...
public  class RiflesFragmentTab extends Fragment {
	...
	public static RiflesFragmentTab InstanceOf() {
		RiflesFragmentTab fragment = new RiflesFragmentTab();
		Bundle bundle = new Bundle();
		bundle.putString(KEY_WEAPON, "rifles");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		holder.view = inflater.inflate(R.layout.fragment_tab_rifles, container,
				false);
