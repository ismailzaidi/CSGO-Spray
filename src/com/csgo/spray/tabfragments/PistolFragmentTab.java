...
public  class PistolFragmentTab extends Fragment {
	...
	public static PistolFragmentTab InstanceOf() {
		PistolFragmentTab fragment = new PistolFragmentTab();
		Bundle bundle = new Bundle();
		bundle.putString(KEY_WEAPON, "pistols");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		holder.view = inflater.inflate(R.layout.fragment_tab_pistol, container,
				false);
